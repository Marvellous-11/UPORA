...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-border-subtle bg-surface text-text-primary shadow-sm transition-all",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex items-center p-5 md:p-6 pt-0 md:pt-0 border-t border-border-subtle/50 mt-4",
      className
    )}
    {...props}
  />
